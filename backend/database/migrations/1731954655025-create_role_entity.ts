...
export class CreateRoleEntity1731954655025 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "role" ("id" character varying NOT NULL, "name" character varying NOT NULL, "permissions" "public"."role_permissions_enum" array NOT NULL, CONSTRAINT "PK_b36bcfe02fc8de3c57a8b2391c2" PRIMARY KEY ("id"))`);
    }
