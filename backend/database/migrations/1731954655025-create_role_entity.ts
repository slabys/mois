...
export class CreateRoleEntity1731954655025 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE IF NOT EXIST "public"."role_permissions_enum" AS ENUM('create.event')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP TYPE IF NOT EXIST "public"."role_permissions_enum"`);
  }
