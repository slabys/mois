...
export class InitStructure1738063280831 implements MigrationInterface {
    name = 'InitStructure1738063280831'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "email" character varying NOT NULL, "username" character varying NOT NULL, "first_name" character varying NOT NULL, "last_name" character varying NOT NULL, "gender" "public"."user_gender_enum" NOT NULL DEFAULT 'prefer-not-to-say', "password" character varying(255) NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "photo_id" uuid, "personal_address_id" integer, "role_id" integer, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "organization" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "address_id" integer NOT NULL, "manager_id" uuid, "parent_id" uuid, CONSTRAINT "PK_472c1f99a32def1b0abb219cd67" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "payment_subject" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "cin" character varying, "vat_id" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "address_id" integer, CONSTRAINT "REL_830895e6f7ce045b2f85c3ff59" UNIQUE ("address_id"), CONSTRAINT "PK_ff0d1ccdd487bd65dc5814d37c0" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."invoice_currency_enum" AS ENUM('CZK', 'EUR')`);
        await queryRunner.query(`CREATE TABLE "invoice" ("id" character varying NOT NULL, "iban" character varying NOT NULL, "swift" character varying NOT NULL, "variable_symbol" integer NOT NULL, "constant_symbol" integer NOT NULL, "currency" "public"."invoice_currency_enum" NOT NULL DEFAULT 'CZK', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "supplier_id" uuid, "subscriber_id" uuid, CONSTRAINT "PK_15d25c200d9bcd8a33f698daf18" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "event_application" ("id" SERIAL NOT NULL, "additional_data" json NOT NULL DEFAULT '{}', "id_number" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "event_id" integer NOT NULL, "organization_id" uuid, "spot_type_id" integer, "personal_address_id" integer, "invoice_address_id" integer, "invoice_id" character varying, CONSTRAINT "UQ_9d199138fbb3111d36af9764c56" UNIQUE ("user_id", "event_id"), CONSTRAINT "REL_d95eaed3aced256304db27b502" UNIQUE ("personal_address_id"), CONSTRAINT "REL_9582f0b3884fbf4b36e6853387" UNIQUE ("invoice_address_id"), CONSTRAINT "PK_1e1754ebb2fbf400511a36335ae" PRIMARY KEY ("id"))`);
